...
```sh
python WithBlackBoxSubModule.py
...
module WithBlackBoxSubModule #(
    ...
    reg sig_add21_3_i1;
    wire sig_add21_3_o;
    BlackBoxSubModule add21_0_inst (
        .i0(sig_add21_0_i0),
        .i1(sig_add21_0_i1),
        .o(sig_add21_0_o)
    );

    BlackBoxSubModule add21_1_inst (
        .i0(sig_add21_1_i0),
        .i1(sig_add21_1_i1),
        .o(sig_add21_1_o)
    );

    BlackBoxSubModule add21_2_inst (
        .i0(sig_add21_2_i0),
        .i1(sig_add21_2_i1),
        .o(sig_add21_2_o)
    );

    BlackBoxSubModule add21_3_inst (
        .i0(sig_add21_3_i0),
        .i1(sig_add21_3_i1),
        .o(sig_add21_3_o)
    );
