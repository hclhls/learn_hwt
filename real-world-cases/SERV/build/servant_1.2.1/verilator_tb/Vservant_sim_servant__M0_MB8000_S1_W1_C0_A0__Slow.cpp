...
VL_CTOR_IMP(Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0) {
...
void Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::__Vconfigure(Vservant_sim__Syms* vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
    if (false && this->__VlSymsp) {}  // Prevent unused
}

Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::~Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0() {
}

void Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::_initial__TOP__servant_sim__dut__3(Vservant_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::_initial__TOP__servant_sim__dut__3\n"); );
...
void Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::_settle__TOP__servant_sim__dut__4(Vservant_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::_settle__TOP__servant_sim__dut__4\n"); );
    Vservant_sim* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0::_ctor_var_reset\n"); );
    // Body
    ...
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data_next_1downto0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data_next_31downto2 = VL_RAND_RESET_I(30);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__q = VL_RAND_RESET_I(1);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_concat_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_concat_1 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_concat_2 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_index_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_concat_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_concat_1 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_concat_2 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_index_0 = VL_RAND_RESET_I(2);
    ...
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__cmp_r_next = VL_RAND_RESET_I(1);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__result_add = VL_RAND_RESET_I(1);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__result_bool = VL_RAND_RESET_I(1);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__result_lt = VL_RAND_RESET_I(1);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_concat_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_concat_1 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_concat_2 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_index_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_concat_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_concat_1 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_concat_2 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_index_0 = VL_RAND_RESET_I(2);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_bool__DOT__tmp_index_0 = VL_RAND_RESET_I(1);
    __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_lt__DOT__tmp_index_0 = VL_RAND_RESET_I(1);
