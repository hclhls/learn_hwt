...
#ifndef _VSERVANT_SIM_SERVANT__M0_MB8000_S1_W1_C0_A0_H_
#define _VSERVANT_SIM_SERVANT__M0_MB8000_S1_W1_C0_A0_H_  // guard
...
VL_MODULE(Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0) {
  public:
    // CELLS
    ...
    struct {
        ...
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data_next_1downto0;
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__q;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_concat_0;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_concat_1;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_concat_2;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_c__DOT__tmp_index_0;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_concat_0;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_concat_1;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_concat_2;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__assig_process_q__DOT__tmp_index_0;
        ...
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__cmp_r_next;
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__result_add;
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__result_bool;
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__result_lt;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_concat_0;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_concat_1;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_concat_2;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_add_cy__DOT__tmp_index_0;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_concat_0;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_concat_1;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_concat_2;
        CData/*1:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_add__DOT__tmp_index_0;
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_bool__DOT__tmp_index_0;
        CData/*0:0*/ __PVT__cpu__DOT__cpu__DOT__alu__DOT__assig_process_result_lt__DOT__tmp_index_0;
    };
    struct {
        ...
        IData/*29:0*/ __PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data_next_31downto2;
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0);  ///< Copying not allowed
  public:
    Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0(const char* name = "TOP");
    ~Vservant_sim_servant__M0_MB8000_S1_W1_C0_A0();
